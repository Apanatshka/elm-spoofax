...
public class ElmParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Elm");
  ...
  { 
    ElmParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = ElmParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = ElmParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(ElmParseControllerGenerated.class);
    }
  ...
  { 
    return ElmParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
